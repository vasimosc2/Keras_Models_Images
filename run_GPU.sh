...
python3 evolutionary_run.py --time 12.0 --population_size 6  --hardwareConstrains True --performaceStoppage False --midway_callback False --early_stopping_acc False
...
python3 plotting/plotParetoCurve.py \
  ...
  --epoch_70_month_run1 Jun --epoch_70_day_run1 23 \
