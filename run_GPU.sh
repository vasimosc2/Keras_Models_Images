...
python3 evolutionary_run.py --time 12.0 --population_size 6  --hardwareConstrains True --performaceStoppage False --midway_callback True --early_stopping_acc False
